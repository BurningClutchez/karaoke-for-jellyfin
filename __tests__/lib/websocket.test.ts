// DISABLED (kept for reference): these tests cover the unused Socket.IO server (src/lib/websocket),
// which is commented out. See __tests__/api/queue-readonly.test.ts for the
// read-only /api/queue that replaced it.
import { it } from "vitest";

it.todo("unused Socket.IO server (src/lib/websocket) is disabled");
